...
namespace Job_Application_Management
{
    public partial class FEmployer_JobDetail : Form
    {
        ...
        {
            if (string.IsNullOrEmpty(textBox_JobName.Text))
            {
